/*
 * Usage: nvcc -o layout layout.cu -arch=sm_80 -std=c++17 -I/path/to/cutlass/include
*/
...
int main() {
    ...
    */
    // Case 1:
    cute::Layout layout1 = cute::make_layout(cute::make_shape(4, 6),
                                    cute::make_stride(6, 1));
    ...
    // cute::make_layout(layout_a, layout_b) ---> new layout's shape = (a.shape, b.shape), new layout's stride = (a.stride, b.stride)
